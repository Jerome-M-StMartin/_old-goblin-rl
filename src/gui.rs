...
use specs::prelude::*;
use super::{ Map, CombatStats, Player, Name, Position, gamelog::GameLog };
...
pub fn draw_ui(ecs: &World, ctx: &mut Rltk) {
    ...
    for (_player, stats) in (&players, &stats).join() {
        ...
        ctx.print_color(1, 43, RGB::named(rltk::RED), RGB::named(rltk::BLACK), &health);
        ctx.print_color(21, 43, RGB::named(rltk::GREEN), RGB::named(rltk::BLACK), &fatigue);
        ctx.print_color(41, 43, RGB::named(rltk::BLUE), RGB::named(rltk::BLACK), &mana);
    }
