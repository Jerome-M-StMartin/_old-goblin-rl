...
impl<'a> System<'a> for ItemUseSystem {
    ...
    fn run(&mut self, data: Self::SystemData) {
        let (player_entity, mut runstate, mut particle_builder, mut gamelog, map, entities, mut use_item_intent,
             ...
             aoe, mut confusion, equippable, mut equip_intent, equipped, mut unequip_intent, magic_mapper) = data;
            ...
            match mapper {
                ...
                Some(_) => {
                    *runstate = RunState::MagicMapReveal{ row: 0 };
                    is_item_used = true;
                    gamelog.entries.push("The blessing of Gaze falls upon you".to_string());
                }
            }
